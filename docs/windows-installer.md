...
本次本地产物 SHA-256：`08B83829022F171E7717BFFEFFEB46A31601061E5B8FFA931B09DC34EB0AC252`。未配置商业代码签名证书，因此公开下载时 Windows SmartScreen 仍可能提示未知发布者；正式分发应在发布工作流中注入项目自己的签名证书。
